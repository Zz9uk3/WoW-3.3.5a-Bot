    ...
    public class AmeisenCore
    {
        ...
        private static WoWObject ReadWoWObjectFromGUID(bool isMyself, int guid)
        {
            ...
            if (isMyself)
            {
                ...
                try
                {
                    Target t = (Target)ReadWoWObjectFromGUID(false, AmeisenManager.GetInstance().GetMemorySharp().Modules.MainModule.Read<int>((AmeisenOffsets.WoWOffsets.partyplayer1) - 0x400000));

                    if (t.guid == leaderGUID)
                        t.isPartyLeader = true;
                    ((Me)wowObject).partymembers.Add(t);
                }
                catch (Exception e)
                {
                    Console.WriteLine(e);
                ...
                try
                {
                    Target t = (Target)ReadWoWObjectFromGUID(false, AmeisenManager.GetInstance().GetMemorySharp().Modules.MainModule.Read<int>((AmeisenOffsets.WoWOffsets.partyplayer2) - 0x400000));
                ...
                try
                {
                    Target t = (Target)ReadWoWObjectFromGUID(false, AmeisenManager.GetInstance().GetMemorySharp().Modules.MainModule.Read<int>((AmeisenOffsets.WoWOffsets.partyplayer3) - 0x400000));
                ...
                try
                {
                    Target t = (Target)ReadWoWObjectFromGUID(false, AmeisenManager.GetInstance().GetMemorySharp().Modules.MainModule.Read<int>((AmeisenOffsets.WoWOffsets.partyplayer4) - 0x400000));
            ...
            wowObject.posX = AmeisenManager.GetInstance().GetMemorySharp().Modules.MainModule.Read<float>((targetBase + 0x79C) - 0x400000);
            wowObject.posY = AmeisenManager.GetInstance().GetMemorySharp().Modules.MainModule.Read<float>((targetBase + 0x798) - 0x400000);
